...
(function dartProgram() {
  ...
  var holders = [C, H, J, P, W, S, Q, X, T, A, B, M, V, F, R, K, Z, E];
  ...
  (function inheritance() {
    ...
    _inherit(T.ShellToggleMessagesEvent, X.MicroSdkEvent);
