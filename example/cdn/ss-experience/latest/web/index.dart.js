...
(function dartProgram() {
  ...
  var holders = [C, H, J, P, W, X, E, A, Q, B, S, Z, M, V, L, R, K, U, T];
  ...
  (function inheritance() {
    ...
    _inherit(E.ShellPostMessageEvent, X.MicroSdkEvent);
