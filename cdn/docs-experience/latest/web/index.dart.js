// Generated by dart2js (fast startup emitter, strong, omit checks, lax runtime type, CSP), the Dart to JavaScript compiler version: 2.7.0.
...
(function dartProgram() {
  ...
  Q = {
    ...
    DocsExperienceAppComponent_render_closure1: function DocsExperienceAppComponent_render_closure1() {
    },
  ...
  X = {JsCustomEvent: function JsCustomEvent() {
    }, CustomEventInit: function CustomEventInit() {
    }},
  Z = {MicroSdkEvent: function MicroSdkEvent() {
    },
  ...
  T = {ShellToggleMessagesEvent: function ShellToggleMessagesEvent(t0) {
      this.e = null;
      this.eventName = t0;
  ...
  A = {
    ...
    _registerComponent: function(componentFactory, skipMethods) {
      var jsConfig, t1, reactComponentClass, t2;
      componentFactory.call$0().toString;
      jsConfig = {childContextKeys: C.List_empty0, contextKeys: C.List_empty0};
      t1 = $.$get$_dartInteropStatics();
      reactComponentClass = self._createReactDartComponentClass(t1, new K.ComponentStatics(componentFactory), jsConfig);
      t1 = componentFactory.call$0();
      t1.toString;
      t2 = J.getInterceptor$x(reactComponentClass);
      t2.set$displayName(reactComponentClass, H.getRuntimeType(t1).toString$0(0));
      t2.set$dartDefaultProps(reactComponentClass, H.ConstantMap_ConstantMap$from(P.LinkedHashMap__makeEmpty(), null, null));
      return new A.ReactDartComponentFactoryProxy(reactComponentClass, self.React.createFactory(reactComponentClass), t2.get$dartDefaultProps(reactComponentClass));
    },
    ...
    syntheticClipboardEventFactory: function(e) {
      ...
      return new V.SyntheticClipboardEvent(t2);
    },
    syntheticKeyboardEventFactory: function(e) {
      ...
      t1.get$repeat(e);
      t1.get$shiftKey(e);
      return new V.SyntheticKeyboardEvent(t2);
    },
    syntheticFocusEventFactory: function(e) {
      ...
      return new V.SyntheticFocusEvent(t2);
    },
    syntheticFormEventFactory: function(e) {
      ...
      t1.get$target(e);
      t1.get$timeStamp(e);
      return new V.SyntheticFormEvent(t1.get$type(e));
    },
    ...
    syntheticMouseEventFactory: function(e) {
      ...
      t1.get$screenY(e);
      t1.get$shiftKey(e);
      return new V.SyntheticMouseEvent(t2);
    },
    syntheticTouchEventFactory: function(e) {
      ...
      t1.get$touches(e);
      return new V.SyntheticTouchEvent(t2);
    },
    syntheticTransitionEventFactory: function(e) {
      ...
      return new V.SyntheticTransitionEvent(t2);
    },
    syntheticAnimationEventFactory: function(e) {
      ...
      t1.get$elapsedTime(e);
      t1.get$pseudoElement(e);
      return new V.SyntheticAnimationEvent(t2);
    },
    syntheticUIEventFactory: function(e) {
      ...
      t1.get$detail(e);
      t1.get$view(e);
      return new V.SyntheticUIEvent(t2);
    },
    syntheticWheelEventFactory: function(e) {
      ...
      t1.get$deltaY(e);
      t1.get$deltaZ(e);
      return new V.SyntheticWheelEvent(t2);
    },
  ...
  V = {PropError: function PropError(t0, t1) {
    ...
    }, SyntheticClipboardEvent: function SyntheticClipboardEvent(t0) {
      this.type = t0;
    }, SyntheticKeyboardEvent: function SyntheticKeyboardEvent(t0) {
      this.type = t0;
    }, SyntheticFocusEvent: function SyntheticFocusEvent(t0) {
      this.type = t0;
    }, SyntheticFormEvent: function SyntheticFormEvent(t0) {
      this.type = t0;
    }, SyntheticDataTransfer: function SyntheticDataTransfer() {
    }, SyntheticMouseEvent: function SyntheticMouseEvent(t0) {
      this.type = t0;
    }, SyntheticTouchEvent: function SyntheticTouchEvent(t0) {
      this.type = t0;
    }, SyntheticTransitionEvent: function SyntheticTransitionEvent(t0) {
      this.type = t0;
    }, SyntheticAnimationEvent: function SyntheticAnimationEvent(t0) {
      this.type = t0;
    }, SyntheticUIEvent: function SyntheticUIEvent(t0) {
      this.type = t0;
    }, SyntheticWheelEvent: function SyntheticWheelEvent(t0) {
      this.type = t0;
  ...
  E = {
    main: function() {
      $.$get$createMicroElement().call$2("docs-experience", P.allowInterop(new E.main_closure()));
    },
    main_closure: function main_closure() {
    }
  };
  var holders = [C, H, J, P, W, S, Q, X, Z, T, A, B, M, V, F, R, K, E];
  ...
  Q.DocsExperienceAppComponent.prototype = {
    render$0: function(_) {
      ...
      t2 = t2.call$1("Docs: using over_react 3.0.0");
      t3 = A.DomProps$($.p).call$1("Counter: " + H.S(_this.get$state(_this).get$counter()));
      t4 = A.DomProps$($.div);
      ...
      t4.set$onClick(0, new Q.DocsExperienceAppComponent_render_closure1());
  ...
  Q.DocsExperienceAppComponent_render_closure.prototype = {
    call$1: function($event) {
      var t1 = this.$this,
        ...
        t3 = t1.get$state(t1).get$counter();
      if (typeof t3 !== "number")
        return t3.$add();
      t2.set$counter(t3 + 1);
  ...
  Q.DocsExperienceAppComponent_render_closure1.prototype = {
    call$1: function($event) {
      var t2,
        _s21_ = "shell:toggle_messages",
        t1 = new T.ShellToggleMessagesEvent(_s21_);
      t1.MicroSdkEvent$2(_s21_, null);
      window;
      t2 = t1.e;
      if (typeof console != "undefined")
        window.console.log(t2);
      window.document.dispatchEvent(t1.e);
    },
    $signature: 7
  };
  ...
  Z.MicroSdkEvent.prototype = {
    MicroSdkEvent$2: function(eventName, detail) {
      var options = {detail: P._convertDataTree(P.LinkedHashMap__makeEmpty()), bubbles: true, cancelable: true, composed: true};
      this.e = new self.CustomEvent(this.eventName, options);
    }
  };
  T.ShellToggleMessagesEvent.prototype = {};
  ...
  A._jsifyContext_closure.prototype = {
    call$2: function(key, value) {
      this.interopContext[key] = new K.ReactDartContextInternal(value);
    }
  };
  A._unjsifyContext_closure.prototype = {
    call$1: function(key) {
      var internal = this.interopContext[key];
  ...
  A.ReactDomComponentFactoryProxy.prototype = {
    ...
    build$2: function(props, childrenArgs) {
      ...
      return this.factory.call$2(R._convertDataTree0(convertibleProps), children);
    }
  };
  ...
  E.main_closure.prototype = {
    call$1: function(e) {
      ...
      $.$get$render().call$2(Q.docs_experience_app___$DocsExperienceApp$closure().call$0().call$0(), e);
  ...
  (function installTearOffs() {
    ...
    _static_1(M, "pretty_print___prettyObj$closure", "_prettyObj", 35);
    ...
    _static_1(A, "react_client__syntheticClipboardEventFactory$closure", "syntheticClipboardEventFactory", 25);
    _static_1(A, "react_client__syntheticKeyboardEventFactory$closure", "syntheticKeyboardEventFactory", 26);
    _static_1(A, "react_client__syntheticFocusEventFactory$closure", "syntheticFocusEventFactory", 27);
    _static_1(A, "react_client__syntheticFormEventFactory$closure", "syntheticFormEventFactory", 28);
    _static_1(A, "react_client__syntheticMouseEventFactory$closure", "syntheticMouseEventFactory", 29);
    _static_1(A, "react_client__syntheticTouchEventFactory$closure", "syntheticTouchEventFactory", 30);
    _static_1(A, "react_client__syntheticTransitionEventFactory$closure", "syntheticTransitionEventFactory", 31);
    _static_1(A, "react_client__syntheticAnimationEventFactory$closure", "syntheticAnimationEventFactory", 32);
    _static_1(A, "react_client__syntheticUIEventFactory$closure", "syntheticUIEventFactory", 33);
    _static_1(A, "react_client__syntheticWheelEventFactory$closure", "syntheticWheelEventFactory", 34);
    _static_2(K, "react_interop_ReactDom_render$closure", "ReactDom_render", 23);
  })();
  (function inheritance() {
    ...
    _inheritMany(H.Closure, [H.Primitives_functionNoSuchMethod_closure, H.unwrapException_saveStackTrace, H.TearOffClosure, H.JsLinkedHashMap_addAll_closure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1, P._HashMap_addAll_closure, P.LinkedHashMap_LinkedHashMap$from_closure, P.MapBase_mapToString_closure, P.NoSuchMethodError_toString_closure, W.MidiInputMap_keys_closure, W.MidiOutputMap_keys_closure, W.RtcStatsReport_keys_closure, W.Storage_addAll_closure, W.Storage_keys_closure, P._wrapToDart_closure, P._wrapToDart_closure0, P._wrapToDart_closure1, P._convertDataTree__convert, P.AudioParamMap_keys_closure, Q.DocsExperienceAppComponent_render_closure, Q.DocsExperienceAppComponent_render_closure0, Q.DocsExperienceAppComponent_render_closure1, Q.DocsExperienceAppComponent_render_closure2, Q.closure, S.UiComponent_validateRequiredProps_closure, S.UiComponent_validateRequiredProps__closure, M._indentString_closure, M._prettyObj_closure, M._prettyObj_closure0, M._prettyObj_closure1, M._prettyObj_closure_renderSubKey, M._prettyObj__closure, M._prettyObj_closure2, M._prettyObj_closure3, F.closure4, V.closure0, A.ReactDartComponentFactoryProxy_generateExtendedJsProps_closure, A._jsifyContext_closure, A._unjsifyContext_closure, A.closure2, A.closure_initComponent, A._initComponent_closure, A._initComponent_closure_jsRedraw, A.closure_handleGetChildContext, A._handleGetChildContext_closure, A.closure_handleComponentWillMount, A._handleComponentWillMount_closure, A.closure_handleComponentDidMount, A._handleComponentDidMount_closure, A.closure__getNextProps, A.closure__afterPropsChange, A.closure__clearPrevState, A.closure__callSetStateCallbacks, A.__callSetStateCallbacks_closure, A.closure__callSetStateTransactionalCallbacks, A.__callSetStateTransactionalCallbacks_closure, A.closure_handleComponentWillReceiveProps, A._handleComponentWillReceiveProps_closure, A.closure_handleShouldComponentUpdate, A._handleShouldComponentUpdate_closure, A.closure_handleComponentWillUpdate, A._handleComponentWillUpdate_closure, A.closure_handleComponentDidUpdate, A._handleComponentDidUpdate_closure, A.closure_handleComponentWillUnmount, A._handleComponentWillUnmount_closure, A.closure_handleRender, A._handleRender_closure, A.unconvertJsProps_closure, A._convertEventHandlers_closure, A._convertEventHandlers__closure, A._dartifyJsMap_closure, R._convertDataTree__convert0, K.markChildrenValidated_closure, R.closure1, Z.closure5, T.closure3, E.main_closure]);
    ...
    _inheritMany(P.MapBase, [H.JsLinkedHashMap, P._HashMap, S._UiProps_MapBase_MapViewMixin]);
    ...
    _inheritMany(W.EventTarget, [W.Node, W.FileWriter, W.MidiPort, W.NetworkInformation, W.ScreenOrientation, W.SourceBuffer, W._SourceBufferList_EventTarget_ListMixin, W.TextTrack, W.TextTrackCue, W._TextTrackList_EventTarget_ListMixin, W.VideoTrackList, W.Window, W.WorkerGlobalScope, P.AudioNode, P.AudioTrackList, P.BaseAudioContext]);
    _inheritMany(W.Node, [W.Element, W.CharacterData, W.DocumentFragment]);
    _inheritMany(W.Element, [W.HtmlElement, P.SvgElement]);
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.ButtonElement, W.EmbedElement, W.FieldSetElement, W.FormElement, W.InputElement, W.LinkElement, W.OListElement, W.ObjectElement, W.OutputElement, W.ScriptElement, W.SelectElement, W.SourceElement, W.StyleElement, W.TextAreaElement]);
    ...
    _inherit(T.ShellToggleMessagesEvent, Z.MicroSdkEvent);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: -1, args: [V.Component]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: -1, args: [V.SyntheticMouseEvent]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.Null, args: [V.SyntheticMouseEvent]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [S.ConsumedProps]}, {func: 1, ret: P.Null, args: [S.PropDescriptor]}, {func: 1, ret: P.JsFunction, args: [,]}, {func: 1, ret: P.JsObject, args: [,]}, {func: 1, ret: P.String, args: [,]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, args: [K.ReactComponent]}, {func: 1, ret: K.InteropContextValue, args: [V.Component]}, {func: 1, ret: [P.JsArray,,], args: [,]}, {func: 1, args: [V.Component]}, {func: 1, ret: P.Null, args: [P.String]}, {func: 1, ret: P.Null, args: [Q.SyntheticEvent], opt: [,,]}, {func: 1, ret: S.DocsExperience, args: [W.ShadowRoot]}, {func: 1, ret: Q._$$DocsExperienceAppProps, opt: [[P.Map,,,]]}, {func: 1, ret: K.ReactComponent, args: [K.ReactElement, W.Element]}, {func: 1, ret: [A.ReactDartComponentFactoryProxy, V.Component], args: [{func: 1, ret: V.Component}], opt: [[P.Iterable, P.String]]}, {func: 1, ret: V.SyntheticClipboardEvent, args: [Q.SyntheticClipboardEvent0]}, {func: 1, ret: V.SyntheticKeyboardEvent, args: [Q.SyntheticKeyboardEvent0]}, {func: 1, ret: V.SyntheticFocusEvent, args: [Q.SyntheticFocusEvent0]}, {func: 1, ret: V.SyntheticFormEvent, args: [Q.SyntheticFormEvent0]}, {func: 1, ret: V.SyntheticMouseEvent, args: [Q.SyntheticMouseEvent0]}, {func: 1, ret: V.SyntheticTouchEvent, args: [Q.SyntheticTouchEvent0]}, {func: 1, ret: V.SyntheticTransitionEvent, args: [Q.SyntheticTransitionEvent0]}, {func: 1, ret: V.SyntheticAnimationEvent, args: [Q.SyntheticAnimationEvent0]}, {func: 1, ret: V.SyntheticUIEvent, args: [Q.SyntheticUIEvent0]}, {func: 1, ret: V.SyntheticWheelEvent, args: [Q.SyntheticWheelEvent0]}, {func: 1, ret: P.String, args: [P.Object]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "createMicroElement", "$get$createMicroElement", function() {
