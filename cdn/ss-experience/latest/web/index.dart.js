...
(function dartProgram() {
  ...
  E = {ShellPostMessageEvent: function ShellPostMessageEvent(t0, t1) {
      this.e = null;
      this.eventName = t0;
      this.detail = t1;
    },
    main: function() {
      $.$get$createMicroElement().call$2("ss-experience", P.allowInterop(new E.main_closure()));
    },
  ...
  A = {
    ...
    syntheticClipboardEventFactory: function(e) {
      ...
      return new V.SyntheticClipboardEvent(new A.syntheticClipboardEventFactory_closure(e), new A.syntheticClipboardEventFactory_closure0(e), t2);
    },
    syntheticKeyboardEventFactory: function(e) {
      ...
      t1.get$repeat(e);
      t1.get$shiftKey(e);
      return new V.SyntheticKeyboardEvent(new A.syntheticKeyboardEventFactory_closure(e), new A.syntheticKeyboardEventFactory_closure0(e), t2);
    },
    syntheticFocusEventFactory: function(e) {
      ...
      return new V.SyntheticFocusEvent(new A.syntheticFocusEventFactory_closure(e), new A.syntheticFocusEventFactory_closure0(e), t2);
    },
    syntheticFormEventFactory: function(e) {
      ...
      t1.get$target(e);
      t1.get$timeStamp(e);
      return new V.SyntheticFormEvent(new A.syntheticFormEventFactory_closure(e), new A.syntheticFormEventFactory_closure0(e), t1.get$type(e));
    },
    ...
    syntheticPointerEventFactory: function(e) {
      ...
      t1.get$isPrimary(e);
      return new V.SyntheticPointerEvent(new A.syntheticPointerEventFactory_closure(e), new A.syntheticPointerEventFactory_closure0(e), t2);
    },
    syntheticMouseEventFactory: function(e) {
      ...
      t1.get$screenY(e);
      t1.get$shiftKey(e);
      return new V.SyntheticMouseEvent(new A.syntheticMouseEventFactory_closure(e), new A.syntheticMouseEventFactory_closure0(e), t2);
    },
    syntheticTouchEventFactory: function(e) {
      ...
      t1.get$touches(e);
      return new V.SyntheticTouchEvent(new A.syntheticTouchEventFactory_closure(e), new A.syntheticTouchEventFactory_closure0(e), t2);
    },
    syntheticTransitionEventFactory: function(e) {
      ...
      return new V.SyntheticTransitionEvent(new A.syntheticTransitionEventFactory_closure(e), new A.syntheticTransitionEventFactory_closure0(e), t2);
    },
    syntheticAnimationEventFactory: function(e) {
      ...
      t1.get$elapsedTime(e);
      t1.get$pseudoElement(e);
      return new V.SyntheticAnimationEvent(new A.syntheticAnimationEventFactory_closure(e), new A.syntheticAnimationEventFactory_closure0(e), t2);
    },
    syntheticUIEventFactory: function(e) {
      ...
      t1.get$detail(e);
      t1.get$view(e);
      return new V.SyntheticUIEvent(new A.syntheticUIEventFactory_closure(e), new A.syntheticUIEventFactory_closure0(e), t2);
    },
    syntheticWheelEventFactory: function(e) {
      ...
      t1.get$deltaY(e);
      t1.get$deltaZ(e);
      return new V.SyntheticWheelEvent(new A.syntheticWheelEventFactory_closure(e), new A.syntheticWheelEventFactory_closure0(e), t2);
    },
  ...
  B = {
    ...
    _$SSExperienceAppComponent: function _$SSExperienceAppComponent(t0, t1) {
      var _ = this;
      _._cachedTypedState = _._cachedTypedProps = null;
      _._postMessageInput = t0;
      _.DisposableManagerProxy__disposableProxy = t1;
  ...
  V = {PropError: function PropError(t0, t1) {
    ...
    }, SyntheticClipboardEvent: function SyntheticClipboardEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticKeyboardEvent: function SyntheticKeyboardEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticFocusEvent: function SyntheticFocusEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticFormEvent: function SyntheticFormEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticDataTransfer: function SyntheticDataTransfer() {
    }, SyntheticMouseEvent: function SyntheticMouseEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticPointerEvent: function SyntheticPointerEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticTouchEvent: function SyntheticTouchEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticTransitionEvent: function SyntheticTransitionEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticAnimationEvent: function SyntheticAnimationEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticUIEvent: function SyntheticUIEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
    }, SyntheticWheelEvent: function SyntheticWheelEvent(t0, t1, t2) {
      this._preventDefault = t0;
      this.stopPropagation = t1;
      this.type = t2;
  ...
  var holders = [C, H, J, P, W, X, Z, E, A, Q, B, S, M, V, L, R, K, U, T];
  ...
  P.Object.prototype = {constructor: P.Object, $isObject: 1,
    ...
    get$current: function($receiver) {
      return this.noSuchMethod$1($receiver, H.createInvocationMirror("current", "get$current", 1, [], [], 0));
    },
  ...
  Z.MicroSdkEvent.prototype = {
    MicroSdkEvent$2: function(eventName, detail) {
      var options = {detail: P._convertDataTree(this.detail), bubbles: true, cancelable: true, composed: true};
  ...
  A.ReactDomComponentFactoryProxy.prototype = {
    build$2: function(props, childrenArgs) {
      var ref,
        children = A.listifyChildren(A._convertArgsToChildren(childrenArgs)),
        convertibleProps = P.LinkedHashMap_LinkedHashMap$from(props, null, null);
      A._convertEventHandlers(convertibleProps);
      ref = convertibleProps.$index(0, "ref");
      if (ref instanceof K.Ref)
        convertibleProps.$indexSet(0, "ref", ref.jsRef);
  ...
  K.Ref.prototype = {
    get$current: function(_) {
      var dartCurrent,
        jsCurrent = J.get$current$x(this.jsRef),
        t1 = J.getInterceptor$(jsCurrent);
      if (!t1.$isElement) {
        H.interceptedTypeCast(jsCurrent, "$isReactComponent");
        dartCurrent = jsCurrent == null ? null : t1.get$dartComponent(jsCurrent);
        if (dartCurrent != null)
          return H.subtypeOfRuntimeTypeCast(dartCurrent, H.getTypeArgumentByIndex(this, 0));
      }
      return jsCurrent;
    }
  };
  ...
  B.SSExperienceAppComponent.prototype = {
    render$0: function(_) {
      ...
      t2 = t2.call$1("Spreadsheets: Using over_react 3.1.0-wip & Component2");
      ...
      t6.props.jsObject.onSubmit = new B.SSExperienceAppComponent_render_closure1(_this);
      ...
      t8.set$type(0, "text");
      t9 = t8.props;
      t9.jsObject.id = "shellMessage";
      t9.$indexSet(0, "ref", _this._postMessageInput);
      t8 = t8.call$0();
  ...
  B.SSExperienceAppComponent_render_closure1.prototype = {
    call$1: function(e) {
      var t1, t2,
        _s18_ = "shell:post_message";
      e.stopPropagation.call$0();
      e._preventDefault.call$0();
      window;
      if (typeof console != "undefined")
        window.console.log("test");
      t1 = this.$this._postMessageInput;
      t1 = P.LinkedHashMap__makeLiteral(["message", t1.get$current(t1).value]);
      t2 = new E.ShellPostMessageEvent(_s18_, t1);
      t2.MicroSdkEvent$2(_s18_, t1);
      window;
      t1 = t2.e;
      if (typeof console != "undefined")
        window.console.log(t1);
      window.document.dispatchEvent(t2.e);
    },
    $signature: 20
  };
  B.closure.prototype = {
    call$0: function() {
      return new B._$SSExperienceAppComponent(new K.Ref(self.React.createRef(), [W.InputElement]), null);
    },
    "call*": "call$0",
    $requiredArgCount: 0
  };
  ...
  E.main_closure.prototype = {
    call$1: function(e) {
      ...
      $.$get$render().call$2(B.ss_experience_app___$SSExperienceApp$closure().call$0().call$0(), e);
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "react_client__ReactDartInteropStatics2_handleComponentDidMount$closure", "_ReactDartInteropStatics2_handleComponentDidMount", 3);
    ...
    _static_1(A, "react_client__ReactDartInteropStatics2_handleComponentWillUnmount$closure", "_ReactDartInteropStatics2_handleComponentWillUnmount", 3);
  ...
  (function inheritance() {
    ...
    _inherit(E.ShellPostMessageEvent, Z.MicroSdkEvent);
